...
test.describe('Sidebar Responsive', () => {
  test('mobile: hamburguer menu should open and close the sidebar', async ({
    page,
  }) => {
  ...
  test('desktop: hamburguer menu should not be visible and content should be visible', async ({
    page,
  }) => {
