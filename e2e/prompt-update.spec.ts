// Implementando o conceito de TDD (Test Driven Development) para criar testes de ponta a ponta (E2E) para a funcionalidade de atualização de prompt.

import { PrismaClient } from '@/generated/prisma/client';
import test, { expect } from '@playwright/test';
import { PrismaPg } from '@prisma/adapter-pg';

test('Prompt Edition via UI (success)', async ({ page }) => {
